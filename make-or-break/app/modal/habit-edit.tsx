...
import { ScreenTitle, CardTitle, CardSubtitle, Text } from '@/src/components/ui/Text';
...
export default function HabitEditModal() {
  ...
  const existingHabit = isEditing ? habits.find((h) => h.id === params.id) : null;
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.toggleContainer}>
            <Pressable
              style={[styles.toggleOption, cadence === 'daily' && styles.toggleOptionActive]}
              onPress={() => setCadence('daily')}
            >
              <Text variant="cardTitle" style={cadence === 'daily' ? styles.toggleTextActive : styles.toggleText}>
                Daily
              </Text>
            </Pressable>
            <Pressable
              style={[styles.toggleOption, cadence === 'weekly' && styles.toggleOptionActive]}
              onPress={() => setCadence('weekly')}
            >
              <Text variant="cardTitle" style={cadence === 'weekly' ? styles.toggleTextActive : styles.toggleText}>
                Weekly
              </Text>
            </Pressable>
          </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.toggleContainer}>
            <Pressable
              style={[styles.toggleOption, polarity === 'build' && styles.toggleOptionActive]}
              onPress={() => setPolarity('build')}
            >
              <Text variant="cardTitle" style={polarity === 'build' ? styles.toggleTextActive : styles.toggleText}>
                Build
              </Text>
            </Pressable>
            <Pressable
              style={[styles.toggleOption, polarity === 'break' && styles.toggleOptionActive]}
              onPress={() => setPolarity('break')}
            >
              <Text variant="cardTitle" style={polarity === 'break' ? styles.toggleTextActive : styles.toggleText}>
                Break
              </Text>
            </Pressable>
          </View>
        ...
        {/* Step Input */}
        <View style={styles.section}>
          <CardSubtitle style={styles.label}>Step (increment amount)</CardSubtitle>
          <TextInput
            style={styles.input}
            value={step}
